...
export function claimWheelReward() {
  ...
  console.log('Before award:', player.powerups[wheelState.result.key]);
  player.powerups[wheelState.result.key] = (player.powerups[wheelState.result.key] || 0) + wheelState.result.count;
  console.log('After award:', player.powerups[wheelState.result.key]);
  console.log('Awarded:', wheelState.result.count, wheelState.result.name);
  
  hideWheel();
  flashMessage(`Got ${wheelState.result.count} ${wheelState.result.name}!`, 1500);
}
